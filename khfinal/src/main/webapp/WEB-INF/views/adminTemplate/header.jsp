			...
			<aside>
				<ul class="sideMenu">
					...
					<li>
						<a href="#">회원 관리</a>
						<ul>
							<li><a href="/admin/member/list?p=1">회원 목록</a></li>
					...
					<li>
						<a href="#">이벤트 관리</a>
						<ul>
							<li><a href="/admin/event/list">이벤트 목록</a></li>
					...
					<li>
						<a href="#">카테고리 관리</a>
						<ul>
							<li><a href="/admin/category/list">카테고리 목록</a></li>
							<li><a href="/admin/category/add">카테고리 추가</a></li>
						</ul>
					</li>
				</ul>
			</aside>
