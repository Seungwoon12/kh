...
<script>
	...
	$(function(){
		...
		$(".list-btn").click(function(){
			...
			location.href = "<%=request.getContextPath()%>/board/list.jsp";//절대경로
		});
...
<div class="outbox" style="width:800px;">
	<div class="row center">
		<h2>
			...
			<%if(boardDto.getBoard_header() != null){%>
							...
							<div class="row left reply-normal">
								...
								<div>
									<%
										...
										String timeFormat = f.format(replyDto.getReply_time());
									%>
									<%=timeFormat%>
				...
				<tr>
					<td colspan="2">
						...
						<form action="reply_insert.do" method="post">
							<input type="hidden" name="reply_origin" value="<%=board_no%>">
							<div class="row">
								<textarea class="input" name="reply_content" required rows="5" placeholder="댓글 작성"></textarea>
							</div>
							<div class="row">
